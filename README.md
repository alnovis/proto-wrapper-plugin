...
| `PRIMITIVE_MESSAGE` | int → Message | `getXxx()` + `getXxxMessage()` | `setXxx(primitive)` + `setXxxMessage(Message)` |
...
The CLI is packaged as an executable JAR (`proto-wrapper-core-1.6.2-cli.jar`).

```bash
# Basic comparison
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2

# Output formats
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2 --format=text
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2 --format=json
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2 --format=markdown

# Show only breaking changes
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2 --breaking-only

# Write to file
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2 --output=diff-report.md

# CI/CD mode: exit code 1 if breaking changes detected
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2 --fail-on-breaking

# Custom version names
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2 --v1-name=production --v2-name=development

# Quiet mode (suppress info messages)
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2 -q

# Custom protoc path
java -jar proto-wrapper-core-1.6.2-cli.jar diff proto/v1 proto/v2 --protoc=/usr/local/bin/protoc
```
