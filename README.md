...
The CLI is packaged as an executable JAR (`proto-wrapper-core-1.5.1-cli.jar`).
...
# Custom protoc path
java -jar proto-wrapper-core-1.5.1-cli.jar diff proto/v1 proto/v2 --protoc=/usr/local/bin/protoc
```
