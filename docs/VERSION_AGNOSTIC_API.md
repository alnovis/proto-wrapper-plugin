...
A comprehensive guide to using the version-agnostic API generated by proto-wrapper plugin (Maven and Gradle).
...
- [API_REFERENCE.md](API_REFERENCE.md) - Generated code API reference
