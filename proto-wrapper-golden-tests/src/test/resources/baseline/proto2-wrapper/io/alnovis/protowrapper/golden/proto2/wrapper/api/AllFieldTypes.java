...
public interface AllFieldTypes extends ProtoWrapper {
    /**
     * @return requiredInt32 value
     */
    int getRequiredInt32();

    /**
     * Check if requiredInt32 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredInt32();

    /**
     * @return requiredInt64 value
     */
    long getRequiredInt64();

    /**
     * Check if requiredInt64 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredInt64();

    /**
     * @return requiredUint32 value
     */
    int getRequiredUint32();

    /**
     * Check if requiredUint32 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredUint32();

    /**
     * @return requiredUint64 value
     */
    long getRequiredUint64();

    /**
     * Check if requiredUint64 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredUint64();

    /**
     * @return requiredSint32 value
     */
    int getRequiredSint32();

    /**
     * Check if requiredSint32 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredSint32();

    /**
     * @return requiredSint64 value
     */
    long getRequiredSint64();

    /**
     * Check if requiredSint64 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredSint64();

    /**
     * @return requiredFixed32 value
     */
    int getRequiredFixed32();

    /**
     * Check if requiredFixed32 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredFixed32();

    /**
     * @return requiredFixed64 value
     */
    long getRequiredFixed64();

    /**
     * Check if requiredFixed64 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredFixed64();

    /**
     * @return requiredSfixed32 value
     */
    int getRequiredSfixed32();

    /**
     * Check if requiredSfixed32 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredSfixed32();

    /**
     * @return requiredSfixed64 value
     */
    long getRequiredSfixed64();

    /**
     * Check if requiredSfixed64 is present.
     * @return true if the field has a value
     */
    boolean hasRequiredSfixed64();

    /**
     * @return requiredFloat value
     */
    float getRequiredFloat();

    /**
     * Check if requiredFloat is present.
     * @return true if the field has a value
     */
    boolean hasRequiredFloat();

    /**
     * @return requiredDouble value
     */
    double getRequiredDouble();

    /**
     * Check if requiredDouble is present.
     * @return true if the field has a value
     */
    boolean hasRequiredDouble();

    /**
     * @return requiredBool value
     */
    boolean isRequiredBool();

    /**
     * Check if requiredBool is present.
     * @return true if the field has a value
     */
    ...
    /**
     * Check if requiredString is present.
     * @return true if the field has a value
     */
    ...
    /**
     * Check if requiredBytes is present.
     * @return true if the field has a value
     */
     ...
     */
    NestedMessage getRequiredMessage();

    /**
     * Check if requiredMessage is present.
     * @return true if the field has a value
     */
    ...
    /**
     * Check if requiredEnum is present.
     * @return true if the field has a value
     */
    boolean hasRequiredEnum();
    ...
    interface Builder {
        /**
         * Set requiredInt32 value.
         */
        Builder setRequiredInt32(int requiredInt32);

        /**
         * Clear requiredInt32 value.
         */
        Builder clearRequiredInt32();

        /**
         * Set requiredInt64 value.
         */
        Builder setRequiredInt64(long requiredInt64);

        /**
         * Clear requiredInt64 value.
         */
        Builder clearRequiredInt64();

        /**
         * Set requiredUint32 value.
         */
        Builder setRequiredUint32(int requiredUint32);

        /**
         * Clear requiredUint32 value.
         */
        Builder clearRequiredUint32();

        /**
         * Set requiredUint64 value.
         */
        Builder setRequiredUint64(long requiredUint64);

        /**
         * Clear requiredUint64 value.
         */
        Builder clearRequiredUint64();

        /**
         * Set requiredSint32 value.
         */
        Builder setRequiredSint32(int requiredSint32);

        /**
         * Clear requiredSint32 value.
         */
        Builder clearRequiredSint32();

        /**
         * Set requiredSint64 value.
         */
        Builder setRequiredSint64(long requiredSint64);

        /**
         * Clear requiredSint64 value.
         */
        Builder clearRequiredSint64();

        /**
         * Set requiredFixed32 value.
         */
        Builder setRequiredFixed32(int requiredFixed32);

        /**
         * Clear requiredFixed32 value.
         */
        Builder clearRequiredFixed32();

        /**
         * Set requiredFixed64 value.
         */
        Builder setRequiredFixed64(long requiredFixed64);

        /**
         * Clear requiredFixed64 value.
         */
        Builder clearRequiredFixed64();

        /**
         * Set requiredSfixed32 value.
         */
        Builder setRequiredSfixed32(int requiredSfixed32);

        /**
         * Clear requiredSfixed32 value.
         */
        Builder clearRequiredSfixed32();

        /**
         * Set requiredSfixed64 value.
         */
        Builder setRequiredSfixed64(long requiredSfixed64);

        /**
         * Clear requiredSfixed64 value.
         */
        Builder clearRequiredSfixed64();

        /**
         * Set requiredFloat value.
         */
        Builder setRequiredFloat(float requiredFloat);

        /**
         * Clear requiredFloat value.
         */
        Builder clearRequiredFloat();

        /**
         * Set requiredDouble value.
         */
        Builder setRequiredDouble(double requiredDouble);

        /**
         * Clear requiredDouble value.
         */
        Builder clearRequiredDouble();

        /**
         * Set requiredBool value.
         */
        Builder setRequiredBool(boolean requiredBool);

        /**
         * Clear requiredBool value.
         */
        Builder clearRequiredBool();

        /**
         * Set requiredString value.
         */
        Builder setRequiredString(String requiredString);

        /**
         * Clear requiredString value.
         */
        Builder clearRequiredString();

        /**
         * Set requiredBytes value.
         */
        Builder setRequiredBytes(byte[] requiredBytes);

        /**
         * Clear requiredBytes value.
         */
        Builder clearRequiredBytes();

        /**
         * Set requiredMessage value.
         */
        Builder setRequiredMessage(NestedMessage requiredMessage);

        /**
         * Clear requiredMessage value.
         */
        Builder clearRequiredMessage();

        /**
         * Set requiredEnum value.
         */
        Builder setRequiredEnum(TestEnum requiredEnum);

        /**
         * Clear requiredEnum value.
         */
        Builder clearRequiredEnum();
