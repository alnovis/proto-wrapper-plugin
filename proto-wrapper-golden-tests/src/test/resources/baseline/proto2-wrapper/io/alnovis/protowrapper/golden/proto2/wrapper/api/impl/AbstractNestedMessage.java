...
public abstract class AbstractNestedMessage<PROTO extends Message> implements NestedMessage {
    ...
    protected abstract boolean extractHasId(PROTO proto);

    protected abstract int extractId(PROTO proto);

    protected abstract boolean extractHasName(PROTO proto);
    ...
    public abstract static class AbstractBuilder<PROTO extends Message> implements NestedMessage.Builder {
        protected abstract void doSetId(int id);

        protected abstract void doClearId();
        ...
        @Override
        public final NestedMessage.Builder setId(int id) {
            doSetId(id);
            return this;
        }

        @Override
        public final NestedMessage.Builder clearId() {
            doClearId();
            return this;
        }
        ...
        @Override
        public final NestedMessage.Builder clearName() {
            doClearName();
            return this;
        }
