...
import io.alnovis.protowrapper.golden.proto2.wrapper.api.ProtoWrapper;
...
class ProtoWrapperGoldenTest {
    ...
    class InterfaceImplementation {
        ...
        void protoWrapper_hasExpectedMethods() throws NoSuchMethodException {
            ...
            assertThat(ProtoWrapper.class.getMethod("getWrapperVersionId")).isNotNull();
    ...
    class GetTypedProto {
        ...
        @MethodSource("io.alnovis.protowrapper.golden.ProtoWrapperGoldenTest#allVersions")
    ...
    class PolymorphicUsage {
        ...
        void instanceOfCheck_worksCorrectly() {
            ...
            if (unknown instanceof ProtoWrapper pw) {
                ...
                assertThat(pw.getWrapperVersionId()).isEqualTo("v1");
            } else {
