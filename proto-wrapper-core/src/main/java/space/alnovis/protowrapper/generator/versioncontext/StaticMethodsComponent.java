 ...
 *   <li>forVersion(int) - deprecated factory method</li>
 * </ul>
 */
public class StaticMethodsComponent implements InterfaceComponent {
    ...
    public void addTo(TypeSpec.Builder builder) {
        ...
        // forVersion(int) - deprecated
        addDeprecatedForVersionMethod(builder, versions);
    }

    private void addDeprecatedForVersionMethod(TypeSpec.Builder builder, List<String> versions) {
        ClassName versionContextType = ClassName.get(config.getApiPackage(), "VersionContext");

        String versionNumExamples = versions.stream()
        ...
        for (String version : versions) {
            ...
            forVersion.addStatement("case $L: return $T.INSTANCE", versionNum, contextClassName);
        }
        ...
        builder.addMethod(forVersion.build());
    }
