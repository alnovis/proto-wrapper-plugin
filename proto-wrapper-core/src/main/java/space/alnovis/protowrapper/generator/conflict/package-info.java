 ...
 * <h2>Key Classes</h2>
 * <ul>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.ConflictHandler} - Handler interface</li>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.FieldProcessingChain} - Chain coordinator</li>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.AbstractConflictHandler} - Base implementation</li>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.ProcessingContext} - Generation context</li>
 * </ul>
 *
 * <h2>Handler Chain</h2>
 * <p>Handlers are processed in order until one accepts the field:</p>
 * <ol>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.IntEnumHandler} - int/enum conflicts</li>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.StringBytesHandler} - string/bytes conflicts</li>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.WideningHandler} - int32/int64 widening</li>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.PrimitiveMessageHandler} - primitive/message conflicts</li>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.RepeatedConflictHandler} - repeated field conflicts</li>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.MapFieldHandler} - map field handling</li>
 *   <li>{@link space.alnovis.protowrapper.generator.conflict.DefaultHandler} - fallback for all other fields</li>
 * </ol>
 *
 * <h2>Usage</h2>
 * <pre>{@code
