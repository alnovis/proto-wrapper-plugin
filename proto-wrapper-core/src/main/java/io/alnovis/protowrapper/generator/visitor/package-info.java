 ...
 * <h2>Key Classes</h2>
 * <ul>
 *   <li>{@link io.alnovis.protowrapper.generator.visitor.MessageVisitor} -
 *       Visitor interface with default empty implementations</li>
 *   <li>{@link io.alnovis.protowrapper.generator.visitor.MessageTraverser} -
 *       Traverses schema and invokes visitor methods</li>
 *   <li>{@link io.alnovis.protowrapper.generator.visitor.FieldCollector} -
 *       Collects all fields from a schema</li>
 *   <li>{@link io.alnovis.protowrapper.generator.visitor.ConflictReporter} -
 *       Reports type conflicts found in schema</li>
 *   <li>{@link io.alnovis.protowrapper.generator.visitor.SchemaStats} -
 ...
 * </ul>
 *
 * @see io.alnovis.protowrapper.generator.visitor.MessageVisitor
 * @see io.alnovis.protowrapper.generator.visitor.MessageTraverser
 */
