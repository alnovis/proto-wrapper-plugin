 ...
 *
 * <ul>
 *   <li>{@link io.alnovis.protowrapper.incremental.IncrementalStateManager} -
 *       Main coordinator for incremental generation</li>
 *   <li>{@link io.alnovis.protowrapper.incremental.IncrementalState} -
 *       Persistent state stored between builds</li>
 *   <li>{@link io.alnovis.protowrapper.incremental.FileFingerprint} -
 *       File content hash for change detection</li>
 *   <li>{@link io.alnovis.protowrapper.incremental.ChangeDetector} -
 *       Detects added, modified, and deleted proto files</li>
 *   <li>{@link io.alnovis.protowrapper.incremental.ProtoDependencyGraph} -
