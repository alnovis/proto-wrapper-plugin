 ...
 * <h2>Key Classes</h2>
 * <ul>
 *   <li>{@link io.alnovis.protowrapper.contract.FieldContract} - The main contract record</li>
 *   <li>{@link io.alnovis.protowrapper.contract.FieldCardinality} - Singular vs repeated vs map</li>
 *   <li>{@link io.alnovis.protowrapper.contract.FieldTypeCategory} - Scalar, message, or enum</li>
 *   <li>{@link io.alnovis.protowrapper.contract.FieldPresence} - Proto2/proto3 presence semantics</li>
 * </ul>
 *
 * <h2>Design Goals</h2>
 * <ol>
 ...
 * }</pre>
 *
 * @see io.alnovis.protowrapper.contract.FieldContract
 */
