...
import io.alnovis.protowrapper.it.model.api.BankTransfer;
import io.alnovis.protowrapper.it.model.api.CreditCard;
import io.alnovis.protowrapper.it.model.api.Crypto;
import io.alnovis.protowrapper.it.model.api.Payment;
...
public class OneofIntegrationTest {
    ...
    class V1PaymentTests {
        ...
        void paymentWithCreditCardV1() {
            ...
            assertEquals("v1", payment.getWrapperVersionId());
    ...
    class V2PaymentTests {
        ...
        void paymentWithCryptoV2() {
            ...
            assertEquals("v2", payment.getWrapperVersionId());
    ...
    class VersionConversionTests {
        ...
        void convertCreditCardV1ToV2() {
            ...
            // Convert to v2
            io.alnovis.protowrapper.it.model.v2.Payment v2 =
                    v1.asVersion(io.alnovis.protowrapper.it.model.v2.Payment.class);
        ...
        void convertCryptoV2ToV1() {
            ...
            io.alnovis.protowrapper.it.model.v1.Payment v1 =
                    v2.asVersion(io.alnovis.protowrapper.it.model.v1.Payment.class);
