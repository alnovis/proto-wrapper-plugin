...
import io.alnovis.protowrapper.it.model.api.Address;
...
public class EqualsHashCodeTest {
    ...
    class TopLevelEquality {
        ...
        void differentVersionSameContent() {
            Money money1 = VersionContext.forVersionId("v1").newMoneyBuilder()
                    .setAmount(1000)
                    .setCurrency("USD")
                    .build();

            Money money2 = VersionContext.forVersionId("v2").newMoneyBuilder()
                    .setAmount(1000)
                    .setCurrency("USD")
                    .build();
        ...
        void comparisonWithNull() {
            Money money = VersionContext.forVersionId("v1").newMoneyBuilder()
                    .setAmount(1000)
                    .setCurrency("USD")
                    .build();
    ...
    class WrappedFromProtoEquality {
        ...
        void wrapperFromSameProto() {
            io.alnovis.protowrapper.it.proto.v1.Common.Money proto =
                    io.alnovis.protowrapper.it.proto.v1.Common.Money.newBuilder()
                            .setAmount(1000)
                            .setCurrency("USD")
                            .build();
        ...
        void wrapperFromEqualProto() {
            io.alnovis.protowrapper.it.proto.v1.Common.Money proto1 =
                    io.alnovis.protowrapper.it.proto.v1.Common.Money.newBuilder()
                            .setAmount(1000)
                            .setCurrency("USD")
                            .build();

            io.alnovis.protowrapper.it.proto.v1.Common.Money proto2 =
                    io.alnovis.protowrapper.it.proto.v1.Common.Money.newBuilder()
                            .setAmount(1000)
                            .setCurrency("USD")
                            .build();
