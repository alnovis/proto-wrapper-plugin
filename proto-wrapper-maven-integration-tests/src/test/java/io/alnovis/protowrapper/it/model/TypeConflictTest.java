...
import io.alnovis.protowrapper.it.proto.v1.Telemetry;
import io.alnovis.protowrapper.it.proto.v2.Telemetry.UnitTypeEnum;
import io.alnovis.protowrapper.it.proto.v2.Telemetry.AlertSeverity;
import io.alnovis.protowrapper.it.proto.v2.Telemetry.SyncStatus;
...
class TypeConflictTest {
    ...
    class IntEnumUnitTypeConflictTest {
        ...
        void v1ReadsUnitTypeAsInt() {
            ...
            SensorReading reading = new io.alnovis.protowrapper.it.model.v1.SensorReading(proto);

            assertThat(reading.getUnitType()).isEqualTo(2);
            assertThat(reading.getWrapperVersionId()).isEqualTo("v1");
        }

        @Test
        @DisplayName("V2 reads unitType as enum, unified interface returns int value")
        void v2ReturnsDefaultForConflictingField() {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading proto =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading.newBuilder()
            ...
            SensorReading reading = new io.alnovis.protowrapper.it.model.v2.SensorReading(proto);

            // Phase 2: Conflicting field now returns actual int value from enum
            assertThat(reading.getUnitType()).isEqualTo(3);  // UNIT_PASCAL = 3
            assertThat(reading.getWrapperVersionId()).isEqualTo("v2");
        }
        ...
        void v2CanAccessActualEnumViaTypedProto() {
            ...
            io.alnovis.protowrapper.it.model.v2.SensorReading reading =
                    new io.alnovis.protowrapper.it.model.v2.SensorReading(proto);
        ...
        void builderAcceptsUnifiedEnum() {
            ...
            SensorReading v1Reading = new io.alnovis.protowrapper.it.model.v1.SensorReading(
        ...
        void bothSettersProduceSameResult() {
            ...
            SensorReading base = new io.alnovis.protowrapper.it.model.v1.SensorReading(baseProto);
    ...
    class IntEnumSeverityConflictTest {
        ...
        void v1ReadsSeverityAsInt() {
            ...
            AlertNotification alert = new io.alnovis.protowrapper.it.model.v1.AlertNotification(proto);
        ...
        void v2ReturnsDefaultForSeverity() {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.AlertNotification proto =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.AlertNotification.newBuilder()
            ...
            AlertNotification alert = new io.alnovis.protowrapper.it.model.v2.AlertNotification(proto);
    ...
    class IntEnumSyncStatusConflictTest {
        ...
        void v1ReadsSyncStatusAsInt() {
            ...
            BatchTelemetry batch = new io.alnovis.protowrapper.it.model.v1.BatchTelemetry(proto);
        ...
        void v2ReturnsDefaultForSyncStatus() {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.BatchTelemetry proto =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.BatchTelemetry.newBuilder()
            ...
            BatchTelemetry batch = new io.alnovis.protowrapper.it.model.v2.BatchTelemetry(proto);
    ...
    class PrimitiveMessageCalibrationConflictTest {
        ...
        void v2ReturnsNullForCalibrationId() {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.CalibrationInfo calibInfo =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.CalibrationInfo.newBuilder()
    ...
    class PrimitiveMessageTimestampConflictTest {
        ...
        void v1ReadsGeneratedAtAsLong() {
            ...
            TelemetryReport report = new io.alnovis.protowrapper.it.model.v1.TelemetryReport(proto);
        ...
        void v2ReturnsDefaultForGeneratedAt() {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.TelemetryReport proto =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.TelemetryReport.newBuilder()
                    .setReportNumber("RPT-002")
                    .setReading(createMinimalV2SensorReading())
                    .setGeneratedAt(createV2Date(2024, 6, 15))
                    .build();

            TelemetryReport report = new io.alnovis.protowrapper.it.model.v2.TelemetryReport(proto);
        ...
        void v2CanAccessDateViaTypedProto() {
            ...
            io.alnovis.protowrapper.it.model.v2.TelemetryReport report =
                    new io.alnovis.protowrapper.it.model.v2.TelemetryReport(proto);
    ...
    class StringBytesChecksumConflictTest {
        ...
        void v1BuilderStringBytesSetters() {
            ...
            TelemetryReport report1 = new io.alnovis.protowrapper.it.model.v1.TelemetryReport(proto1)
                    .toBuilder()
            ...
            TelemetryReport report2 = new io.alnovis.protowrapper.it.model.v1.TelemetryReport(proto1)
                    .toBuilder()
        ...
        void v2BuilderStringBytesSetters() {
            ...
            io.alnovis.protowrapper.it.proto.v2.Telemetry.TelemetryReport proto1 =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.TelemetryReport.newBuilder()
                            .setReportNumber("RPT-001")
                            .setReading(createMinimalV2SensorReading())
            ...
            TelemetryReport report1 = new io.alnovis.protowrapper.it.model.v2.TelemetryReport(proto1)
                    .toBuilder()
                    .setChecksum("test-checksum")
                    .build();
            ...
            // Set via Bytes
            byte[] checksumBytes = "bytes-checksum".getBytes(java.nio.charset.StandardCharsets.UTF_8);
            TelemetryReport report2 = new io.alnovis.protowrapper.it.model.v2.TelemetryReport(proto1)
                    .toBuilder()
                    .setChecksumBytes(checksumBytes)
                    .build();
    ...
    class NestedPrimitiveMessageConflictTest {
        ...
        void v1ReadsParentIdAsInt() {
            io.alnovis.protowrapper.it.proto.v1.Conflicts.NestedPrimitiveMessageConflicts proto =
                    io.alnovis.protowrapper.it.proto.v1.Conflicts.NestedPrimitiveMessageConflicts.newBuilder()
                            .setId("TEST-001")
                            .setName("Test Item")
                            .setParentId(12345)
            ...
            io.alnovis.protowrapper.it.model.api.NestedPrimitiveMessageConflicts wrapper =
                    new io.alnovis.protowrapper.it.model.v1.NestedPrimitiveMessageConflicts(proto);
        ...
        void v2ReadsParentIdAsNestedMessage() {
            io.alnovis.protowrapper.it.proto.v2.Conflicts.NestedPrimitiveMessageConflicts.ParentRef parentRef =
                    io.alnovis.protowrapper.it.proto.v2.Conflicts.NestedPrimitiveMessageConflicts.ParentRef.newBuilder()
                            .setRefNumber("REF-2024-001")
                            .setRefType("PARENT")
                            .build();

            io.alnovis.protowrapper.it.proto.v2.Conflicts.NestedPrimitiveMessageConflicts proto =
                    io.alnovis.protowrapper.it.proto.v2.Conflicts.NestedPrimitiveMessageConflicts.newBuilder()
                            .setId("TEST-002")
            ...
            io.alnovis.protowrapper.it.model.api.NestedPrimitiveMessageConflicts wrapper =
                    new io.alnovis.protowrapper.it.model.v2.NestedPrimitiveMessageConflicts(proto);
        ...
        void v2SupportsNestedMessageOnly() {
            ...
            io.alnovis.protowrapper.it.model.api.NestedPrimitiveMessageConflicts.ParentRef parentWrapper =
        ...
        void v2CanAccessNestedMessageViaTypedProto() {
            ...
            io.alnovis.protowrapper.it.model.v2.NestedPrimitiveMessageConflicts wrapper =
                    new io.alnovis.protowrapper.it.model.v2.NestedPrimitiveMessageConflicts(proto);
        ...
        void nonConflictingFieldsWork() {
            io.alnovis.protowrapper.it.proto.v1.Conflicts.NestedPrimitiveMessageConflicts v1Proto =
                    io.alnovis.protowrapper.it.proto.v1.Conflicts.NestedPrimitiveMessageConflicts.newBuilder()
                            .setId("ID-V1")
                            .setName("Name V1")
            ...
            io.alnovis.protowrapper.it.proto.v2.Conflicts.NestedPrimitiveMessageConflicts v2Proto =
                    io.alnovis.protowrapper.it.proto.v2.Conflicts.NestedPrimitiveMessageConflicts.newBuilder()
                            .setId("ID-V2")
                            .setName("Name V2")
            ...
            io.alnovis.protowrapper.it.model.api.NestedPrimitiveMessageConflicts v1 =
                    new io.alnovis.protowrapper.it.model.v1.NestedPrimitiveMessageConflicts(v1Proto);
            io.alnovis.protowrapper.it.model.api.NestedPrimitiveMessageConflicts v2 =
                    new io.alnovis.protowrapper.it.model.v2.NestedPrimitiveMessageConflicts(v2Proto);
    ...
    class RepeatedConflictsTest {
        ...
        void v1RepeatedIntWidenedToLong() {
            io.alnovis.protowrapper.it.proto.v1.Conflicts.RepeatedConflicts proto =
                    io.alnovis.protowrapper.it.proto.v1.Conflicts.RepeatedConflicts.newBuilder()
                            .addNumbers(100)
                            .addNumbers(200)
                            .addNumbers(300)
            ...
            io.alnovis.protowrapper.it.model.api.RepeatedConflicts wrapper =
                    new io.alnovis.protowrapper.it.model.v1.RepeatedConflicts(proto);
        ...
        void v2RepeatedLongReturnsList() {
            io.alnovis.protowrapper.it.proto.v2.Conflicts.RepeatedConflicts proto =
                    io.alnovis.protowrapper.it.proto.v2.Conflicts.RepeatedConflicts.newBuilder()
            ...
            io.alnovis.protowrapper.it.model.api.RepeatedConflicts wrapper =
                    new io.alnovis.protowrapper.it.model.v2.RepeatedConflicts(proto);
        ...
        void v2RepeatedEnumConvertedToInt() {
            io.alnovis.protowrapper.it.proto.v2.Conflicts.RepeatedConflicts proto =
                    io.alnovis.protowrapper.it.proto.v2.Conflicts.RepeatedConflicts.newBuilder()
                            .addCodes(io.alnovis.protowrapper.it.proto.v2.Conflicts.CodeEnum.CODE_SUCCESS)
                            .addCodes(io.alnovis.protowrapper.it.proto.v2.Conflicts.CodeEnum.CODE_WARNING)
                            .addCodes(io.alnovis.protowrapper.it.proto.v2.Conflicts.CodeEnum.CODE_ERROR)
        ...
        @DisplayName("Non-conflicting fields work across versions")
        void nonConflictingFieldsWork() {
            io.alnovis.protowrapper.it.proto.v1.Conflicts.RepeatedConflicts v1Proto =
                    io.alnovis.protowrapper.it.proto.v1.Conflicts.RepeatedConflicts.newBuilder()
                            .setBatchId("BATCH-001")
                            .build();

            io.alnovis.protowrapper.it.proto.v2.Conflicts.RepeatedConflicts v2Proto =
                    io.alnovis.protowrapper.it.proto.v2.Conflicts.RepeatedConflicts.newBuilder()
                            .setBatchId("BATCH-002")
                            .setItemCount(42)
                            .build();

            io.alnovis.protowrapper.it.model.api.RepeatedConflicts v1 =
                    new io.alnovis.protowrapper.it.model.v1.RepeatedConflicts(v1Proto);
            io.alnovis.protowrapper.it.model.api.RepeatedConflicts v2 =
                    new io.alnovis.protowrapper.it.model.v2.RepeatedConflicts(v2Proto);
        ...
        void builderSupportsRepeatedConflictFields() {
            ...
            io.alnovis.protowrapper.it.model.api.RepeatedConflicts modified = wrapper.toBuilder()
                    .setBatchId("MODIFIED")
                    .setItemCount(20)
    ...
    private io.alnovis.protowrapper.it.proto.v1.Common.Date createV1Date(int year, int month, int day) {
        return io.alnovis.protowrapper.it.proto.v1.Common.Date.newBuilder()
                .setYear(year)
                .setMonth(month)
                .setDay(day)
                .build();
    ...
    private io.alnovis.protowrapper.it.proto.v2.Common.Date createV2Date(int year, int month, int day) {
        return io.alnovis.protowrapper.it.proto.v2.Common.Date.newBuilder()
                .setYear(year)
                .setMonth(month)
                .setDay(day)
                .build();
    ...
    private io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading createMinimalV2SensorReading() {
        return io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading.newBuilder()
                .setSensorId("SENSOR-MIN")
                .setDeviceName("Minimal")
                .setUnitType(UnitTypeEnum.UNIT_CELSIUS)
