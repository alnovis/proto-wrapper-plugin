...
class StaticNewBuilderTest {
    ...
    class TopLevelInterfaceTests {
        ...
        class DateNewBuilderTest {
            ...
            void createsV1BuilderWithV1Context() {
                ...
                assertThat(date.getWrapperVersionId()).isEqualTo("v1");
            }
            ...
            void createsV2BuilderWithV2Context() {
                ...
                assertThat(date.getWrapperVersionId()).isEqualTo("v2");
            }
        }
        ...
        class AddressNewBuilderTest {
            ...
            void createsV1BuilderWithV1Context() {
                ...
                assertThat(address.getWrapperVersionId()).isEqualTo("v1");
            }
            ...
            void createsV2BuilderWithNestedGeoLocation() {
                ...
                assertThat(address.getWrapperVersionId()).isEqualTo("v2");
    ...
    class RoundTripTests {
        ...
        void moneyRoundTrip() throws Exception {
            ...
            Money restored = ctx.wrapMoney(
                    io.alnovis.protowrapper.it.proto.v1.Common.Money.parseFrom(bytes));
        ...
        void addressWithNestedRoundTrip() throws Exception {
            ...
            Address restored = ctx.wrapAddress(
                    io.alnovis.protowrapper.it.proto.v2.Common.Address.parseFrom(bytes));
    ...
    class CrossVersionCompatibilityTests {
        ...
        void v1MoneyConvertedToV2() {
            ...
            // Convert V1 to V2
            Money moneyV2 = moneyV1.asVersion(io.alnovis.protowrapper.it.model.v2.Money.class);
    ...
    class GetContextIntegrationTests {
        ...
        void contextMatchesBetweenApproaches() {
            ...
            assertThat(viaStatic.getContext().getVersionId())
                    .isEqualTo(viaContext.getContext().getVersionId());
        }
    }
    ...
    class ToBuilderIntegrationTests {
        ...
        void emptyBuilderCreatesNewEmptyBuilder() {
            ...
            assertThat(empty.getWrapperVersionId()).isEqualTo("v2");
        }
    }
}
