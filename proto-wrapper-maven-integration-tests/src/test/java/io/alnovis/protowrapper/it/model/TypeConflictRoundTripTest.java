...
class TypeConflictRoundTripTest {
    ...
    class V1SensorReadingRoundTripTest {
        ...
        void v1RoundTripWithAllFields() throws InvalidProtocolBufferException {
            ...
            // Wrap in API
            SensorReading reading = new io.alnovis.protowrapper.it.model.v1.SensorReading(original);
            ...
            SensorReading restored = new io.alnovis.protowrapper.it.model.v1.SensorReading(parsed);
            ...
            assertThat(restored.getWrapperVersionId()).isEqualTo("v1");
        }
        ...
        void v1BuilderForNonConflictingFields() {
            ...
            SensorReading reading = new io.alnovis.protowrapper.it.model.v1.SensorReading(initial);
    ...
    class V1TelemetryReportRoundTripTest {
        ...
        void v1ReportRoundTrip() throws InvalidProtocolBufferException {
            ...
            TelemetryReport report = new io.alnovis.protowrapper.it.model.v1.TelemetryReport(original);
            byte[] bytes = report.toBytes();

            Telemetry.TelemetryReport parsed = Telemetry.TelemetryReport.parseFrom(bytes);
            TelemetryReport restored = new io.alnovis.protowrapper.it.model.v1.TelemetryReport(parsed);
    ...
    class V1BatchTelemetryRoundTripTest {
        ...
        void v1BatchRoundTrip() throws InvalidProtocolBufferException {
            ...
            BatchTelemetry batch = new io.alnovis.protowrapper.it.model.v1.BatchTelemetry(original);
            byte[] bytes = batch.toBytes();

            Telemetry.BatchTelemetry parsed = Telemetry.BatchTelemetry.parseFrom(bytes);
            BatchTelemetry restored = new io.alnovis.protowrapper.it.model.v1.BatchTelemetry(parsed);
    ...
    class V2SensorReadingRoundTripTest {
        ...
        void v2RoundTripWithEnums() throws InvalidProtocolBufferException {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading original =
                    ...
                    .setCalibrationInfo(io.alnovis.protowrapper.it.proto.v2.Telemetry.CalibrationInfo.newBuilder()
            ...
            io.alnovis.protowrapper.it.model.v2.SensorReading reading =
                    new io.alnovis.protowrapper.it.model.v2.SensorReading(original);
            ...
            byte[] bytes = reading.toBytes();
            io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading parsed =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading.parseFrom(bytes);
            io.alnovis.protowrapper.it.model.v2.SensorReading restored =
                    new io.alnovis.protowrapper.it.model.v2.SensorReading(parsed);
        ...
        void v2BuilderForNonConflictingFields() {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading initial =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading.newBuilder()
                    .setSensorId("SENSOR-INIT")
                    .setDeviceName("Initial")
            ...
            SensorReading reading = new io.alnovis.protowrapper.it.model.v2.SensorReading(initial);
        ...
        void v2WithNestedMetadataRoundTrip() throws InvalidProtocolBufferException {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading.SensorMetadata metadata =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading.SensorMetadata.newBuilder()
            ...
            SensorReading reading = new io.alnovis.protowrapper.it.model.v2.SensorReading(original);
            ...
            io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading parsed =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading.parseFrom(bytes);
            SensorReading restored = new io.alnovis.protowrapper.it.model.v2.SensorReading(parsed);
    ...
    class V2TelemetryReportRoundTripTest {
        ...
        void v2ReportWithBytesRoundTrip() throws InvalidProtocolBufferException {
            ...
            io.alnovis.protowrapper.it.proto.v2.Telemetry.TelemetryReport original =
            ...
            io.alnovis.protowrapper.it.model.v2.TelemetryReport report =
                    new io.alnovis.protowrapper.it.model.v2.TelemetryReport(original);
            ...
            // Round-trip
            byte[] bytes = report.toBytes();
            io.alnovis.protowrapper.it.proto.v2.Telemetry.TelemetryReport parsed =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.TelemetryReport.parseFrom(bytes);
            io.alnovis.protowrapper.it.model.v2.TelemetryReport restored =
                    new io.alnovis.protowrapper.it.model.v2.TelemetryReport(parsed);
        ...
        void v2ReportBuilderRoundTrip() {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.TelemetryReport initial =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.TelemetryReport.newBuilder()
            ...
            TelemetryReport report = new io.alnovis.protowrapper.it.model.v2.TelemetryReport(initial);
    ...
    class V2BatchTelemetryRoundTripTest {
        ...
        void v2BatchWithStatisticsRoundTrip() throws InvalidProtocolBufferException {
            io.alnovis.protowrapper.it.proto.v2.Telemetry.BatchTelemetry.BatchStatistics stats =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.BatchTelemetry.BatchStatistics.newBuilder()
                    .setMinValue(100)
                    .setMaxValue(500)
                    .setAverageValue(275.5)
                    .build();

            io.alnovis.protowrapper.it.proto.v2.Telemetry.BatchTelemetry original =
            ...
            io.alnovis.protowrapper.it.model.v2.BatchTelemetry batch =
                    new io.alnovis.protowrapper.it.model.v2.BatchTelemetry(original);
            ...
            // Round-trip
            byte[] bytes = batch.toBytes();
            io.alnovis.protowrapper.it.proto.v2.Telemetry.BatchTelemetry parsed =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.BatchTelemetry.parseFrom(bytes);
            io.alnovis.protowrapper.it.model.v2.BatchTelemetry restored =
                    new io.alnovis.protowrapper.it.model.v2.BatchTelemetry(parsed);
    ...
    class CrossVersionPolymorphicTest {
        ...
        void processMixedVersions() {
            ...
            Telemetry.SensorReading v1Proto = Telemetry.SensorReading.newBuilder()
                    ...
                    .build();
            SensorReading v1Reading = new io.alnovis.protowrapper.it.model.v1.SensorReading(v1Proto);

            // Create V2 reading
            io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading v2Proto =
                    io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading.newBuilder()
                    ...
                    .build();
            SensorReading v2Reading = new io.alnovis.protowrapper.it.model.v2.SensorReading(v2Proto);
            ...
            for (SensorReading reading : readings) {
                ...
                if ("v1".equals(reading.getWrapperVersionId())) {
        ...
        void builderWorksForBothVersions() {
            ...
            Telemetry.SensorReading v1Proto = Telemetry.SensorReading.newBuilder()
                    ...
                    .setReadingDate(createV1Date(2024, 1, 1))
                    .build();
            SensorReading v1 = new io.alnovis.protowrapper.it.model.v1.SensorReading(v1Proto);
            ...
            io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading v2Proto =
                    ...
                    .setReadingDate(createV2Date(2024, 1, 1))
                    .build();
            SensorReading v2 = new io.alnovis.protowrapper.it.model.v2.SensorReading(v2Proto);
            ...
            for (SensorReading reading : readings) {
                SensorReading modified = reading.toBuilder()
                        .setSensorId("MODIFIED-" + reading.getWrapperVersionId())
                        .setLocation("Common Location")
                        .build();

                assertThat(modified.getSensorId())
                        .isEqualTo("MODIFIED-" + reading.getWrapperVersionId());
                assertThat(modified.getLocation()).isEqualTo("Common Location");
                assertThat(modified.getWrapperVersionId()).isEqualTo(reading.getWrapperVersionId());
            }
        }
    }
    ...
    private io.alnovis.protowrapper.it.proto.v2.Telemetry.SensorReading createFullV2SensorReading() {
