...
import io.alnovis.protowrapper.it.model.api.VersionSpecificFields;
...
public class VersionConversionEdgeCasesTest {
    ...
    class AsVersionDataLoss {
        ...
        void v1ToV2LosesV1OnlyFields() {
            ...
            // Act: Convert to v2
            VersionSpecificFields v2 = v1.asVersion(io.alnovis.protowrapper.it.model.v2.VersionSpecificFields.class);
        ...
        void v2ToV1LosesV2OnlyFields() {
            ...
            // Act: Convert to v1
            VersionSpecificFields v1 = v2.asVersion(io.alnovis.protowrapper.it.model.v1.VersionSpecificFields.class);
        ...
        void sameVersionConversionPreservesData() {
            ...
            VersionSpecificFields v1Same = v1.asVersion(io.alnovis.protowrapper.it.model.v1.VersionSpecificFields.class);
    ...
    class RoundTripConversion {
        ...
        void roundTripPreservesDataViaUnknownFields() {
            ...
            VersionSpecificFields v2 = original.asVersion(io.alnovis.protowrapper.it.model.v2.VersionSpecificFields.class);
            VersionSpecificFields backToV1 = v2.asVersion(io.alnovis.protowrapper.it.model.v1.VersionSpecificFields.class);
    ...
    class AsVersionStrictTest {
        ...
        void throwsWhenFieldsWouldBecomeInaccessible() {
            ...
            IllegalStateException ex = assertThrows(IllegalStateException.class, () ->
                v1.asVersionStrict(io.alnovis.protowrapper.it.model.v2.VersionSpecificFields.class)
            );
        ...
        void succeedsWhenNoFieldsWouldBecomeInaccessible() {
            ...
            // Should not throw
            VersionSpecificFields v2 = v1.asVersionStrict(io.alnovis.protowrapper.it.model.v2.VersionSpecificFields.class);
        ...
        void returnsSameInstanceForSameVersion() {
            ...
            VersionSpecificFields same = v1.asVersionStrict(io.alnovis.protowrapper.it.model.v1.VersionSpecificFields.class);
        ...
        void v2ToV1ThrowsWhenV2FieldsPopulated() {
            ...
            IllegalStateException ex = assertThrows(IllegalStateException.class, () ->
                v2.asVersionStrict(io.alnovis.protowrapper.it.model.v1.VersionSpecificFields.class)
            );
    ...
    class VersionSpecificMessageTest {
        ...
        void staticNewBuilderThrowsForV1Context() {
            ...
            UnsupportedOperationException ex = assertThrows(
                    UnsupportedOperationException.class,
                    () -> io.alnovis.protowrapper.it.model.api.Crypto.newBuilder(ctx1)
            );
        ...
        void staticNewBuilderWorksForV2Context() {
            ...
            // Should not throw
            assertDoesNotThrow(() ->
                io.alnovis.protowrapper.it.model.api.Crypto.newBuilder(ctx2)
            );
        }
    }
}
