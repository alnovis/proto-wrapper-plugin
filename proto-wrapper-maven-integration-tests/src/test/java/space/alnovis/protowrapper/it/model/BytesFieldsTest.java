...
class BytesFieldsTest {
    ...
    class V1BytesFieldsBuilderTest {
        ...
        void createWithRequiredBytesField() {
            ...
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest wrapper =
        ...
        void createWithNestedBytesPayload() {
            ...
            // Wrap the proto
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest wrapper =
                    new space.alnovis.protowrapper.it.model.v1.BytesFieldsTest(proto);
        ...
        void modifyBytesFieldsViaToBuilder() {
            ...
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest wrapper =
                    new space.alnovis.protowrapper.it.model.v1.BytesFieldsTest(initial);

            // Modify via toBuilder()
            byte[] newData = "modified data".getBytes(StandardCharsets.UTF_8);
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest modified = wrapper.toBuilder()
                    .setId("MODIFIED")
        ...
        void clearOptionalBytesField() {
            ...
            // Clear via builder
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest cleared = wrapper.toBuilder()
                    .clearOptionalBinary()
                    .build();
    ...
    class V2BytesFieldsBuilderTest {
        ...
        void v2RoundTrip() throws InvalidProtocolBufferException {
            ...
            space.alnovis.protowrapper.it.proto.v2.Conflicts.BytesFieldsTest parsed =
                    space.alnovis.protowrapper.it.proto.v2.Conflicts.BytesFieldsTest.parseFrom(bytes);
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest restored =
                    new space.alnovis.protowrapper.it.model.v2.BytesFieldsTest(parsed);
    ...
    class CrossVersionBytesTest {
        ...
        void processUniformly() {
            // Create V1
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest v1 =
                    space.alnovis.protowrapper.it.model.v1.BytesFieldsTest.newBuilder()
                            .setId("V1")
                            .setBinaryData(SAMPLE_BINARY_DATA)
                            .build();
            ...
            // Create V2
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest v2 =
                    space.alnovis.protowrapper.it.model.v2.BytesFieldsTest.newBuilder()
                            .setId("V2")
                            .setBinaryData(SAMPLE_BINARY_DATA)
                            .build();
            ...
            // Process uniformly
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest[] wrappers = {v1, v2};

            for (space.alnovis.protowrapper.it.model.api.BytesFieldsTest wrapper : wrappers) {
                assertThat(wrapper.getBinaryData()).isEqualTo(SAMPLE_BINARY_DATA);
