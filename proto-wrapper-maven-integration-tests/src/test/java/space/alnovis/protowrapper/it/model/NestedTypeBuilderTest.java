...
class NestedTypeBuilderTest {
    ...
    class V1NestedTypeBuilderTest {
        ...
        void nestedTypeHasGetTypedProto() throws Exception {
            ...
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest.BinaryPayload payload =
                    space.alnovis.protowrapper.it.model.v1.BytesFieldsTest.BinaryPayload.newBuilder()
        ...
        void parentBuilderAcceptsNestedWrapper() {
            ...
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest parent =
                    space.alnovis.protowrapper.it.model.v1.BytesFieldsTest.newBuilder()
        ...
        void modifyNestedAndSetInParent() {
            ...
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest.BinaryPayload initialPayload =
                    space.alnovis.protowrapper.it.model.v1.BytesFieldsTest.BinaryPayload.newBuilder()
                            .setContent(SAMPLE_CONTENT)
                            .setContentType("text/plain")
                            .build();
            ...
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest.BinaryPayload modifiedPayload =
            ...
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest modifiedParent =
                    parent.toBuilder()
        ...
        void roundTripWithNestedTypeBuilder() throws Exception {
            ...
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest original =
                    space.alnovis.protowrapper.it.model.v1.BytesFieldsTest.newBuilder()
            ...
            // Deserialize
            space.alnovis.protowrapper.it.proto.v1.Conflicts.BytesFieldsTest parsed =
                    space.alnovis.protowrapper.it.proto.v1.Conflicts.BytesFieldsTest.parseFrom(bytes);
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest restored =
                    new space.alnovis.protowrapper.it.model.v1.BytesFieldsTest(parsed);
    ...
    class V2NestedTypeBuilderTest {
        ...
        void v2NestedTypeHasGetTypedProto() throws Exception {
            // Create a nested wrapper via builder
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest.BinaryPayload payload =
                    space.alnovis.protowrapper.it.model.v2.BytesFieldsTest.BinaryPayload.newBuilder()
                            .setContent(SAMPLE_CONTENT)
                            .setSignature(SAMPLE_SIGNATURE)
                            .setContentType("application/octet-stream")
                            .build();
        ...
        void v2ParentBuilderAcceptsNestedWrapper() {
            ...
            // Use in parent
            space.alnovis.protowrapper.it.model.api.BytesFieldsTest parent =
                    space.alnovis.protowrapper.it.model.v2.BytesFieldsTest.newBuilder()
                            .setId("V2-NESTED-001")
                            .setBinaryData(SAMPLE_CONTENT)
                            .setPayload(payload)
                            .build();
    ...
    class DeeplyNestedTypeBuilderTest {
        ...
        void innerDataHasGetTypedProto() throws Exception {
            ...
            space.alnovis.protowrapper.it.model.api.SimpleNestedConflicts.InnerData innerData =
                    space.alnovis.protowrapper.it.model.v1.SimpleNestedConflicts.InnerData.newBuilder()
                            .setValue(42)
                            .setTypeCode(1)
                            .setData("test data")
                            .build();
        ...
        void parentBuilderAcceptsInnerData() {
            ...
            space.alnovis.protowrapper.it.model.api.SimpleNestedConflicts parent =
                    space.alnovis.protowrapper.it.model.v1.SimpleNestedConflicts.newBuilder()
