...
public class VersionConversionTest {
    ...
    class MoneyConversion {
        ...
        void convertMoneyV1ToV2() {
            ...
            // Convert to v2
            space.alnovis.protowrapper.it.model.v2.Money v2 =
                    v1.asVersion(space.alnovis.protowrapper.it.model.v2.Money.class);
        ...
        void convertMoneyV2ToV1() {
            ...
            // Convert to v1
            space.alnovis.protowrapper.it.model.v1.Money v1 =
                    v2.asVersion(space.alnovis.protowrapper.it.model.v1.Money.class);
        ...
        void asVersionReturnsSameInstanceWhenCorrectType() {
            VersionContext ctx1 = VersionContext.forVersion(1);
            space.alnovis.protowrapper.it.model.v1.Money v1 = (space.alnovis.protowrapper.it.model.v1.Money)
            ...
            space.alnovis.protowrapper.it.model.v1.Money result =
                    v1.asVersion(space.alnovis.protowrapper.it.model.v1.Money.class);
    ...
    class DateConversion {
        ...
        void convertDateV1ToV2() {
            ...
            // Convert to v2
            space.alnovis.protowrapper.it.model.v2.Date v2 =
                    v1.asVersion(space.alnovis.protowrapper.it.model.v2.Date.class);
        ...
        void convertDateV2ToV1() {
            ...
            // Convert to v1
            space.alnovis.protowrapper.it.model.v1.Date v1 =
                    v2.asVersion(space.alnovis.protowrapper.it.model.v1.Date.class);
    ...
    class PolymorphicUsage {
        ...
        void useInterfaceReferenceForConversion() {
            ...
            Money money = VersionContext.forVersion(1)
                    .newMoneyBuilder()
                    .setAmount(750L)
                    .setCurrency("JPY")
                    .build();
            ...
            space.alnovis.protowrapper.it.model.v2.Money v2 =
                    money.asVersion(space.alnovis.protowrapper.it.model.v2.Money.class);
        ...
        void roundTripConversionPreservesData() {
            // Start with v1
            Money original = VersionContext.forVersion(1)
                    .newMoneyBuilder()
                    .setAmount(999L)
                    .setCurrency("CHF")
                    .build();
            ...
            // Convert v1 -> v2 -> v1
            Money v2 = original.asVersion(space.alnovis.protowrapper.it.model.v2.Money.class);
            Money backToV1 = v2.asVersion(space.alnovis.protowrapper.it.model.v1.Money.class);

            // Data should be preserved
            assertEquals(original.getAmount(), backToV1.getAmount());
            assertEquals(original.getCurrency(), backToV1.getCurrency());
            assertEquals(1, backToV1.getWrapperVersion());
        }
    }
    ...
    class ParseFromBytes {
        ...
        void parseMoneyFromBytesWorks() throws Exception {
            ...
            assertEquals(2, parsed.getWrapperVersion());
